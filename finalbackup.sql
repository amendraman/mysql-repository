...
--
-- Definition of table `otherauthordesc`
--

DROP TABLE IF EXISTS `otherauthordesc`;
CREATE TABLE `otherauthordesc` (
...
--
-- Dumping data for table `otherauthordesc`
--

/*!40000 ALTER TABLE `otherauthordesc` DISABLE KEYS */;
/*!40000 ALTER TABLE `otherauthordesc` ENABLE KEYS */;
...
--
-- Create schema hibernatemanytomany
--

CREATE DATABASE IF NOT EXISTS hibernatemanytomany;
USE hibernatemanytomany;
...
--
-- Create schema hibernateonetomany
--

CREATE DATABASE IF NOT EXISTS hibernateonetomany;
USE hibernateonetomany;
...
CREATE TABLE `student` (
  ...
  KEY `FK_f789jhbq0hiq26j2a71rqnmsp` (`college_id`),
  CONSTRAINT `FK_f789jhbq0hiq26j2a71rqnmsp` FOREIGN KEY (`college_id`) REFERENCES `college` (`collegeId`)
...
INSERT INTO `student` (`studentId`,`studentName`,`college_id`) VALUES 
 (1,'Rocky',1),
 (2,'Tanvi',1);
/*!40000 ALTER TABLE `student` ENABLE KEYS */;

--
-- Create schema hibernateonetoonemapping
--

CREATE DATABASE IF NOT EXISTS hibernateonetoonemapping;
USE hibernateonetoonemapping;
...
CREATE TABLE `customer` (
  ...
  PRIMARY KEY (`txn_id`),
  CONSTRAINT `customer_ibfk_1` FOREIGN KEY (`txn_id`) REFERENCES `transact` (`txn_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `person` (
  ...
  `pdetail` int(11) DEFAULT NULL,
  PRIMARY KEY (`personId`),
  KEY `FK_hkuog52t7mvmoq6yhqhhyydvd` (`pdetail`),
  CONSTRAINT `FK_hkuog52t7mvmoq6yhqhhyydvd` FOREIGN KEY (`pdetail`) REFERENCES `persondetails` (`detailid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
--
-- Definition of table `persondetails`
--
...
--
-- Create schema hibernateonetooneperson
--

CREATE DATABASE IF NOT EXISTS hibernateonetooneperson;
USE hibernateonetooneperson;
...
/*!40000 ALTER TABLE `person` DISABLE KEYS */;
INSERT INTO `person` (`personId`,`personName`,`pdetail`) VALUES 
 (1,'Anand',1);
/*!40000 ALTER TABLE `person` ENABLE KEYS */;


--
-- Definition of table `person_detail`
--
...
/*!40000 ALTER TABLE `persondetails` DISABLE KEYS */;
INSERT INTO `persondetails` (`detailid`,`income`,`job`,`zipCode`) VALUES 
 (1,2343,'Architect','110024');
/*!40000 ALTER TABLE `persondetails` ENABLE KEYS */;
...
CREATE TABLE `books` (
  `orchard_tid` int(11) NOT NULL,
  `orchard_track` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`orchard_tid`)
...
--
-- Definition of table `camptable`
--

DROP TABLE IF EXISTS `camptable`;
CREATE TABLE `camptable` (
  `campusMind_id` int(11) NOT NULL,
  `campusMind_name` varchar(30) DEFAULT NULL,
  `campusMind_Location` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`campusMind_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `camptable`
--

/*!40000 ALTER TABLE `camptable` DISABLE KEYS */;
/*!40000 ALTER TABLE `camptable` ENABLE KEYS */;


--
-- Definition of table `campusmindspojo`
--

DROP TABLE IF EXISTS `campusmindspojo`;
CREATE TABLE `campusmindspojo` (
  `campusMindmID` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `campusmindspojo`
--

/*!40000 ALTER TABLE `campusmindspojo` DISABLE KEYS */;
/*!40000 ALTER TABLE `campusmindspojo` ENABLE KEYS */;


--
-- Definition of table `campusmindtable`
--

DROP TABLE IF EXISTS `campusmindtable`;
CREATE TABLE `campusmindtable` (
  `campusMind_id` int(11) NOT NULL,
  `track_id` int(11) NOT NULL,
  `campusMind_name` varchar(30) DEFAULT NULL,
  `campusMind_Location` varchar(30) DEFAULT NULL,
  `lead_tid` int(11) DEFAULT NULL,
  PRIMARY KEY (`campusMind_id`),
  KEY `FKlxr9wosaexmsvp49hhpb2pbqd` (`lead_tid`),
  CONSTRAINT `FKlxr9wosaexmsvp49hhpb2pbqd` FOREIGN KEY (`lead_tid`) REFERENCES `leadtable` (`lead_id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `campusmindtable`
--

/*!40000 ALTER TABLE `campusmindtable` DISABLE KEYS */;
INSERT INTO `campusmindtable` (`campusMind_id`,`track_id`,`campusMind_name`,`campusMind_Location`,`lead_tid`) VALUES 
 (100,1,'Rocky','Kalinga',2),
 (200,2,'Sendo','Nippon',1);
/*!40000 ALTER TABLE `campusmindtable` ENABLE KEYS */;
...
--
-- Definition of table `leadpojo`
--

DROP TABLE IF EXISTS `leadpojo`;
CREATE TABLE `leadpojo` (
  `leadmID` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `leadpojo`
--

/*!40000 ALTER TABLE `leadpojo` DISABLE KEYS */;
/*!40000 ALTER TABLE `leadpojo` ENABLE KEYS */;


--
-- Definition of table `leadtable`
--

DROP TABLE IF EXISTS `leadtable`;
CREATE TABLE `leadtable` (
  `lead_id` int(11) NOT NULL,
  `lead_tid` int(11) NOT NULL,
  `lead_name` varchar(30) DEFAULT NULL,
  `lead_location` varchar(30) DEFAULT NULL,
  `orchard_tid` int(11) DEFAULT NULL,
  PRIMARY KEY (`lead_id`),
  KEY `FK8t2qqs4jebcrd5oekrgxup4mw` (`orchard_tid`),
  CONSTRAINT `FK8t2qqs4jebcrd5oekrgxup4mw` FOREIGN KEY (`orchard_tid`) REFERENCES `orchardtable` (`orchard_tid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `leadtable`
--

/*!40000 ALTER TABLE `leadtable` DISABLE KEYS */;
INSERT INTO `leadtable` (`lead_id`,`lead_tid`,`lead_name`,`lead_location`,`orchard_tid`) VALUES 
 (1,1,'Sanjay','MindtreeKalinga',1),
 (2,2,'Prem','MindtreeKalinga',2);
/*!40000 ALTER TABLE `leadtable` ENABLE KEYS */;


--
-- Definition of table `orchardprogrampojo`
--

DROP TABLE IF EXISTS `orchardprogrampojo`;
CREATE TABLE `orchardprogrampojo` (
  `campusmindMID` int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Dumping data for table `orchardprogrampojo`
--

/*!40000 ALTER TABLE `orchardprogrampojo` DISABLE KEYS */;
/*!40000 ALTER TABLE `orchardprogrampojo` ENABLE KEYS */;


--
-- Definition of table `orchardtable`
--

DROP TABLE IF EXISTS `orchardtable`;
CREATE TABLE `orchardtable` (
  `orchard_tid` int(11) NOT NULL,
  `orchard_track` varchar(30) DEFAULT NULL,
  PRIMARY KEY (`orchard_tid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `orchardtable`
--

/*!40000 ALTER TABLE `orchardtable` DISABLE KEYS */;
INSERT INTO `orchardtable` (`orchard_tid`,`orchard_track`) VALUES 
 (1,'EAI'),
 (2,'Java');
/*!40000 ALTER TABLE `orchardtable` ENABLE KEYS */;
...
INSERT INTO `user_info` (`id`,`name`,`address`) VALUES 
 (0,'First user',NULL),
 (122,'Shubham','Orchard'),
 (123,'Shanks','Nippon'),
 (124,'Naneet','India'),
 (125,'BoogeyMan','Horror house'),
 (126,'nix','delhi'),
 (127,'Prem','Mindtree'),
 (128,'Tarun','UP');
...
/*!40000 ALTER TABLE `person` DISABLE KEYS */;
INSERT INTO `person` (`ID`,`AGE`,`FULL_NAME`) VALUES 
 (1,2,'sdf'),
 (2,21,'ROCKY'),
 (3,22,'Tanvi'),
 (4,25,'Nitesh'),
...
--
-- Create schema restdatabase2
--

CREATE DATABASE IF NOT EXISTS restdatabase2;
USE restdatabase2;
...
--
-- Create schema restfulwebsite
--

CREATE DATABASE IF NOT EXISTS restfulwebsite;
USE restfulwebsite;
...
DROP TABLE IF EXISTS `campusmind`;
CREATE TABLE `campusmind` (
  `campusmindid` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `campusmindname` varchar(45) NOT NULL,
  `campusmindtrack` varchar(45) NOT NULL,
  `campusmindemail` varchar(45) NOT NULL,
  PRIMARY KEY (`campusmindid`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
DROP TABLE IF EXISTS `student`;
CREATE TABLE `student` (
  `studnetId` int(11) NOT NULL AUTO_INCREMENT,
...
/*!40000 ALTER TABLE `student` DISABLE KEYS */;
INSERT INTO `student` (`studnetId`,`firstname`,`lastname`,`yearLevel`) VALUES 
 (1,'Rocky','Sendo',1),
 (2,'Ragini','KV',5),
 (3,'Rakshit','Banu',10),
 (4,'Nikhil','Praveen',6);
